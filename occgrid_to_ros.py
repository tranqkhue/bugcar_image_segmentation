...
def og_msg(occ_grid, map_resolution, map_width, map_height, time_stamp):
    ...
    map_msg.info.origin.position.x = MAP_HEIGHT  # Unit: Meter
    map_msg.info.origin.position.y = -MAP_WIDTH/2  # Unit: Meter
    map_msg.info.origin.position.z = 0
    map_msg.info.origin.orientation = Quaternion()
    map_msg.info.origin.orientation.x = 0
    map_msg.info.origin.orientation.y = 0
    map_msg.info.origin.orientation.z = 1/np.sqrt(2)
    map_msg.info.origin.orientation.w = 1/np.sqrt(2)
