...
class TestOccupancy_grid:
    ...
    def test_2(self, seeImgandShutdown):
        ...
        new = transformer.create_occupancy_grid(segmap_2)
        cv2.imshow("new2", new)
    ...
    def test_3(self, seeImgandShutdown):
        ...
        new = transformer.create_occupancy_grid(segmap_3)
        cv2.imshow("new3", new)
    ...
    def test_4(self, seeImgandShutdown):
        ...
        new = transformer.create_occupancy_grid(segmap_4)
        cv2.imshow("new4", new)
        a = seeImgandShutdown

    def test_5(self, seeImgandShutdown):
        segmap_5 = np.ones(shape=(512, 1024))
        new = transformer.create_occupancy_grid(segmap_5)
        cv2.imshow("new5", new)
        a = seeImgandShutdown
